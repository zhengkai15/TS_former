# -*- coding: utf-8 -*-
# @Time    : 2022/10/23 17:35
# @Author  : kaizheng！！ 156252108@qq.com
# @FileName: trainer_pytorch.py
# @Software: PyCharm
...
from model.nbeats_pytorch.data import get_m4_data, dummy_data_generator
from model.nbeats_pytorch.model import NBeatsNet

CHECKPOINT_PATH = 'results/Nbeats'
CHECKPOINT_NAME = 'results/Nbeats/nbeats-training-checkpoint.th'
